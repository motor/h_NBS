function cf_ = h_erfcfit(x,pX)
%H_ERFCFIT    Create plot of datasets and fits
%   H_ERFCFIT(X,PX)
...
%    Unweighted
%
% This function was automatically generated on 13-Nov-2008 14:01:05
...
cf_ = fit(x(ok_),pX(ok_),ft_,'Startpoint',st_);

% Or use coefficients from the original fit:
if 0
   cv_ = {6072.823315091, 160.5, 1.192994555217};
   cf_ = cfit(ft_,cv_{:});
end
